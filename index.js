...
*/
const A187 = '👾Rizkybotwa👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/ff.rizkygans1'; // JANGAN UBAH-UBAH INFO!!!
const nomer = '088292030664'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/JQCK8pBNAXM6wuPrFRXW3F'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UChgdeBl3JTdHuOoppdyaNcQ'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ff.rizkygans1.ig`))
...
conn.sendMessage(id, ' *Owner Rizkybotwa 0882-9203-0664* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator Rizkybotwa 0882-9203-0664* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *Rizkybotwa* , Follow Instagram Mimin Yah😻 : https://instagram.com/ff.rizkygans1' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *Rizkybotwa* , Follow Instagram Mimin Yah😻 : https://instagram.com/ff.rizkygans1' ,MessageType.text);
}
